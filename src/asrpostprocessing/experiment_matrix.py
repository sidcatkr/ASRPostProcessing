...
DEFAULT_KEYWORD_STRENGTH_SWEEP = DEFAULT_EXPERIMENT_KEYWORD_WEIGHTS
DEFAULT_STRENGTH_SWEEP = DEFAULT_EXPERIMENT_STRENGTHS
DEFAULT_RAG_TOP_K_SWEEP = DEFAULT_EXPERIMENT_RAG_TOP_KS
